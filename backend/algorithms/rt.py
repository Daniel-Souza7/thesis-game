...
class RT:
    ...
    def __init__(self, model, payoff, hidden_size=40, factors=(1., 1.),
                 train_ITM_only=True, use_payoff_as_input=True,
                 use_barrier_as_input=False, activation='gelu', dropout=0.0,
                 **kwargs):
        """
        ...
        Args:
            ...
            activation: Activation function ('relu', 'tanh', 'elu', 'leakyrelu', 'gelu')
    ...
    def predict_exercise_decisions(self, test_paths):
        ...
        This method is for compatibility with the existing API code.
        Uses backward induction approach.
